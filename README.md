...
**[CozyClay](https://github.com/NomaDamas/CozyClay)** ★603 — open-source previs studio in the browser (Three.js / R3F)
...
**[oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** ★68.7k — the agent harness for complex codebases
...
- Restore npm-launcher parity in the compiled `omo-native` entry — [#7489](https://github.com/code-yeongyu/oh-my-openagent/pull/7489) (approved, awaiting merge)

**[Gajae Code](https://github.com/Yeachan-Heo/gajae-code)** ★2.7k — coding agent
...
- Decode quoted (non-ASCII) diff paths as UTF-8 bytes in the `gh` tool — [#5071](https://github.com/Yeachan-Heo/gajae-code/pull/5071) (merged)

**[GraphRAG](https://github.com/microsoft/graphrag)** ★35.9k — Microsoft's graph-based RAG system
...
![Notable contributions](./metrics.notable.svg?v=8)
